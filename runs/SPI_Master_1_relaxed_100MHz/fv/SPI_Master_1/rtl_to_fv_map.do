...
# Generated on: Sat May 23 02:44:06 IST 2026 (Fri May 22 21:14:06 UTC 2026)
...
set logfile fv/SPI_Master_1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/SPI_Master_1 -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86"
set env(CW_DIR) "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/cadence/install_RB_8.7/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /home/userdata/22bec0985/llm_project/baseline_designs -library -both
read_library -liberty -both \
    /home/userdata/22bec0985/llm_project/baseline_designs/tcbn65gpluswcz_ccs.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/22bec0985/GenusHelper/rtl_source/SPI_Master_1.v
elaborate_design -golden -root {SPI_Master_1} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/SPI_Master_1/fv_map.v.gz
elaborate_design -revised -root {SPI_Master_1}
...
#add_name_alias fv/SPI_Master_1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.SPI_Master_1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.SPI_Master_1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.SPI_Master_1.rtl.fv_map.rpt
