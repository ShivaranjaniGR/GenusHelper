...
# Generated on: Sat May 23 02:47:58 IST 2026 (Fri May 22 21:17:58 UTC 2026)
...
set logfile fv/spi_master_2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/spi_master_2 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/userdata/22bec0985/GenusHelper/rtl_source/spi_master_2.v
elaborate_design -golden -root {spi_master_2} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/spi_master_2/fv_map.v.gz
elaborate_design -revised -root {spi_master_2}
...
#add_name_alias fv/spi_master_2/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.spi_master_2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.spi_master_2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.spi_master_2.rtl.fv_map.rpt
